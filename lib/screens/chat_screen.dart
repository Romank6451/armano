...
class ChatScreen extends StatefulWidget {
  ...
  DocumentSnapshot dataCoversation;


  ChatScreen(this.dataCoversation);
  @override
  _ChatScreenState createState() => _ChatScreenState(this.dataCoversation);
}
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  _ChatScreenState(this.dataCoversation);

  @override
  void initState() {
    // TODO: implement initState
    super.initState();
    print("chat with"+dataCoversation.documentID);
...
//      print(ss["service"]);
  ...
  Widget build(BuildContext context) {
    ...
    Firestore.instance.collection("conversations").document(dataCoversation.documentID).updateData({
      "unreadmsg":0
    });
...
//                            });
                         ...
                         await Firestore.instance.collection("conversations").document(dataCoversation.documentID)
...
//                            "to":user.uid,
                          ...
                          Firestore.instance.collection("users").document(dataCoversation.documentID).setData({
              ...
              child: Container(
                ...
                child: StreamBuilder(
                  ...
                  stream: Firestore.instance
                      ...
                      .document(dataCoversation.documentID)
                      .collection("messages")
                    ...
                    if (snap.hasData){
                     ...
                     return ListView.builder (
                       ...
                       itemBuilder: (context,i){
                         ...
                         bool ismine=(dataCoversation.documentID!=snapshot["from"]);
...
//                             )
  ...
  void sentoffer(){
     Firestore.instance.collection("conversations").document(dataCoversation.documentID)
        .collection("messages").document().setData({

      "time":FieldValue.serverTimestamp(),
      "type":1,
      "status":0,
      "from":dataCoversation.documentID.toString(),
      "read":0,
